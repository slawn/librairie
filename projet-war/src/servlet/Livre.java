...
public class Livre extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req , HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
                ...
                ajoutNbPanier = Integer.parseInt( req.getParameter("ajoutNbPanier") );
            } catch ( NumberFormatException e ) {}

        if ( ajoutNbPanier > 0 ) {


            ajoutNbPanier = new SessionUtilisateur(req).getPannier().addLivre(new SessionUtilisateur(req), livre, ajoutNbPanier);
